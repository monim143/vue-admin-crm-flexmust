        ...
        <li class="timeline-event">
          ...
          <base-block title="Meeting" header-bg class="timeline-event-block">
            ...
            <b-media class="font-size-sm push">
              ...
              <p>
                You have a meal meeting scheduled with <a class="font-w600" href="javascript:void(0)">MA Monim</a> today at 16:18.
              </p>
            </b-media>
          </base-block>
        </li>
          ...
          <base-block title="System" header-bg class="timeline-event-block">
            ...
            <div class="alert alert-success d-flex align-items-center justify-content-between" role="alert">
              <div class="flex-fill mr-3">
                <p class="mb-0">Flexmust was successfully <a class="alert-link" href="javascript:void(0)">updated</a> to v{{ $store.getters.appVersion }}!</p>
              </div>
