    ...
    <div class="content">
      ...
      <b-tabs class="block" nav-class="nav-tabs-block" content-class="block-content">
        ...
        <b-tab title="Classic">
          <!-- Classic -->
          <div class="font-size-h4 font-w600 p-2 mb-4 border-left border-4x border-primary bg-body-light">
            <span class="text-primary font-w700">280</span> websites found for <mark class="text-danger">Flexmust</mark>
          </div>
          <b-row class="row py-3">
            <b-col lg="6" v-for="index in 12" :key="index">
              <h4 class="h5 mb-1">
                <a href="javascript:void(0)">Flexmust - CRM</a>
              </h4>
              <div class="font-size-sm text-success mb-1">https://MA Monim.com/</div>
